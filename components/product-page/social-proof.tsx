      ...
      <Container>
        <div className="rounded-[2rem] border border-border-subtle bg-surface-raised p-7 text-text-primary md:p-10">
          ...
          <div className="mt-5 flex flex-wrap items-center gap-3">
            <span className="inline-flex items-center gap-1 rounded-full border border-border-default px-3 py-1 text-xs uppercase tracking-[0.14em] text-text-secondary">
