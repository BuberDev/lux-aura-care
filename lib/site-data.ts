...
export const products: ProductDefinition[] = [
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B08817H6HS",
        name: "BeeVines Jedwabna maska do spania, 2 opakowania 100% prawdziwego naturalnego czystego jedwabiu",
        price: { status: "verified", amount: 67.99, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B0FS1H4SQQ",
        name: "URPOWER Ceramiczny dyfuzor olejków eterycznych, 120 ml",
        price: { status: "verified", amount: 106.00, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B07WWC3T9Q",
        name: "BAIMEI Rose Quartz Gua Sha Massager",
        price: { status: "verified", amount: 67.92, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B076DSBHD1",
        name: "M3 Naturals Olejek do masażu antycellulitowego z kolagenem i stem cell",
        price: { status: "verified", amount: 458.94, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B005F1ATJQ",
        name: "Antike 750 g Mineral Magnez Badeflocken",
        price: { status: "verified", amount: 166.12, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B088419TZG",
        name: "RoC Retinol Correxion Serum wygładzające nocne - 30 kapsułek",
  ...
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B016RFJDL8",
        name: "EcoTools Pędzel do suchego ciała Detoksykujący i wygładzający",
        price: { status: "verified", amount: 77.37, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B0FJS8ZQWS",
        name: "RENPHO Maska LED do Twarzy, czerwone i niebieskie światło LED, 630 nm i 850 nm",
        price: { status: "verified", amount: 753.40, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B0C6G7JFR9",
        name: "Good Nite Koc obciążeniowy dla dorosłych, szary, 6 kg, 125 x 180 cm",
        price: { status: "verified", amount: 186.25, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B07L3XSF65",
        name: "HEETA Szczotka do masażu skóry głowy do mokrych i suchych włosów",
        price: { status: "verified", amount: 48.76, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B0DGTMR754",
        name: "medicube Salmon DNA PDRN różowa żelowa maska kolagenowa, 28 g, 4 szt.",
        price: { status: "verified", amount: 50.00, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B003B6IQI8",
        name: "Woodwick Świeca zapachowa w słoiku, Trilogy Hot Woods",
        price: { status: "verified", amount: 234.84, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
    ...
    marketVariants: {
      ...
      pl: {
        ...
        marketProductId: "B07WSS5M4Z",
        name: "Naturium Serum do twarzy z niacynamidem 12% Plus Cynk 2%",
        price: { status: "verified", amount: 166.64, currency: "PLN", checkedAt: "2026-07-04" },
      },
    },
  },
  {
